...
resource "volterra_http_loadbalancer" "lb_https" {
  ...
  namespace   = var.xc_namespace
  description = format("HTTP LB with WAF for Arcadia, DVWA, Boutique, crAPI and Mailhog on AWS RE without nginx")
  ...
  default_route_pools {
    pool {
      name      = volterra_origin_pool.origins["arcadia_main"].name
      namespace = var.xc_namespace
    }
    weight = 1
  }
  ...
  routes {
    simple_route {
      ...
      origin_pools {
        pool {
          name      = volterra_origin_pool.origins["arcadia_files"].name
          namespace = var.xc_namespace
        }
        weight = 1
      }
  ...
  routes {
    simple_route {
      ...
      origin_pools {
        pool {
          name      = volterra_origin_pool.origins["arcadia_api"].name
          namespace = var.xc_namespace
        }
        weight = 1
      }
  ...
  routes {
    simple_route {
      ...
      origin_pools {
        pool {
          name      = volterra_origin_pool.origins["arcadia_app3"].name
          namespace = var.xc_namespace
        }
        weight = 1
      }
  ...
  routes {
    simple_route {
      ...
      origin_pools {
        pool {
          name      = volterra_origin_pool.origins["dvwa"].name
          namespace = var.xc_namespace
        }
        weight = 1
      }
  ...
  routes {
    simple_route {
      ...
      origin_pools {
        pool {
          name      = volterra_origin_pool.origins["boutique"].name
          namespace = var.xc_namespace
        }
        weight = 1
      }
  ...
  routes {
    simple_route {
      ...
      origin_pools {
        pool {
          name      = volterra_origin_pool.origins["crapi"].name
          namespace = var.xc_namespace
        }
        weight = 1
      }
  ...
  routes {
    simple_route {
      ...
      origin_pools {
        pool {
          name      = volterra_origin_pool.origins["mailhog"].name
          namespace = var.xc_namespace
        }
        weight = 1
      }
